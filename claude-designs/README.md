...
- AIM logo canonical path: `~/My Drive/AI mindset/pics/logo_light.png`
- Source repo: `~/Documents/_code/_generators/aim-studio/`
- Sync script: `~/Documents/_code/_generators/aim-studio/scripts/sync-claude-designs.mjs`
